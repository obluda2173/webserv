...
protected:
    ...
    void TearDown() override {
        const auto& param = GetParam();
        if (param.setupType == TestDeleteHandlerParams::NONE) return;
        struct stat st;
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        TestDeleteHandlerParams{
            ...
            TestDeleteHandlerParams::NON_EMPTY_DIR,
            RequestBuilder()
                .withMethod("DELETE")
                .withUri("/file.txt")
                .build(),
        ...
        TestDeleteHandlerParams{
            "./tests/unittests/test_root/delete_root/dir",
            TestDeleteHandlerParams::DIR_SETUP,
            RequestBuilder()
                .withMethod("DELETE")
                .withUri("/delete_root/dir")
                .build(),
            RouteConfigBuilder()
        ...
        TestDeleteHandlerParams{
            "./tests/unittests/test_root/non_empty_dir",
            TestDeleteHandlerParams::NON_EMPTY_DIR,
            RequestBuilder()
                .withMethod("DELETE")
                .withUri("/non_empty_dir")
                .build(),
            RouteConfigBuilder()
                .withRoot("./tests/unittests/test_root")
                .build(),
        ...
        TestDeleteHandlerParams{
            "./tests/unittests/test_root/readonly.txt",
            TestDeleteHandlerParams::READONLY_FILE,
            RequestBuilder()
                .withMethod("DELETE")
                .withUri("/readonly.txt")
                .build(),
            RouteConfigBuilder()
                .withRoot("./tests/unittests/test_root")
                .build(),
        ...
        TestDeleteHandlerParams{
            "./tests/unittests/test_root/valid_file.txt",
            TestDeleteHandlerParams::FILE_SETUP,
            RequestBuilder()
                .withMethod("DELETE")
                .withUri("/../../../etc/passwd")
                .build(),
        ...
        TestDeleteHandlerParams{
            "./tests/unittests/test_root/secure_file.txt",
            TestDeleteHandlerParams::READONLY_FILE,
            RequestBuilder()
                .withMethod("DELETE")
                .withUri("/secure_file.txt")
                .build(),
            RouteConfigBuilder()
                .withRoot("./tests/unittests/test_root")
