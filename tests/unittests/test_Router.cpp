...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        // "GET"},
        RouterTestParams{HttpRequest{"GET", "/js/", "HTTP/1.1", {{"host", "test.com"}}}, {"GET"}, {"/data/scripts", {}, {}, 1024, false}},
        RouterTestParams{HttpRequest{"GET", "/keys/", "HTTP/1.1", {{"host", "test.com"}}},
                         {"GET", "POST", "DELETE"},
                         {"/var/www/secure", {"index.html", "index.htm"}, {}, 1024, false}},
        RouterTestParams{HttpRequest{"GET", "/images/", "HTTP/1.1", {{"host", "example.com"}}}, {"GET", "POST", "DELETE"}, {"/data", {}, {}, 1024, false}},
        RouterTestParams{HttpRequest{"GET", "/css/", "HTTP/1.1", {{"host", "example.com"}}}, {"GET", "POST"}, {"/data/static", {}, {}, 1024, false}},
        RouterTestParams{HttpRequest{"GET", "/index.html", "HTTP/1.1", {{"host", "example.com"}}}, {"GET"}, {"/var/www/html", {}, {}, 1024, false}},
        RouterTestParams{HttpRequest{"GET", "/", "HTTP/1.1", {{"host", "example.com"}}}, {"GET"}, {"/var/www/html", {}, {}, 1024, false}},
        RouterTestParams{HttpRequest{"GET", "/", "HTTP/1.1", {{"host", "test.com"}}},
                         {"GET", "POST", "DELETE"},
                         {"/var/www/secure", {"index.html", "index.htm"}, {}, 1024, false}},
        RouterTestParams{HttpRequest{"GET", "/", "HTTP/1.1", {{"host", "test2.com"}}}, {"GET"}, {"/usr/share/nginx/html", {}, {}, 1024, false}}));
